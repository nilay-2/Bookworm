          ...
          <div class="row mb-5">
            <div class="col-md-6">
              <div class="block-16">
                <figure>
                  <img
                    src="https://cdn.carrot.com/uploads/sites/48363/2022/03/real-estate-books.jpg"
                    alt="Loading"
            ...
            <div class="col-md-5">
              ...
              <p class="text-black">
                We are students just like most of you. We also face the same
                problems of buying and selling books before the upcoming
                semester. We wanted to create one plaform for buying and selling
                of books where all people can connect.
              </p>
              <p class="text-black">
                So we created BookWorm with the aim to make sure that buyer and
                seller can transact with each other without any middleman.
              </p>
            </div>
          </div>
        </div>
              ...
              <div class="block-38 text-center">
                <div class="block-38-img">
                  <div class="block-38-header">
                    ...
                    <h3 class="block-38-heading h4">lorem</h3>
            ...
            <div className="col-md-6 col-lg-3">
              <div className="block-5 mb-5">
                ...
                <ul className="list-unstyled">
                  ...
                  <li className="email">
                    <a href="bookworm@gmail.com">bookworm@gmail.com</a>
                  </li>
                </ul>
              </div>
            </div>
